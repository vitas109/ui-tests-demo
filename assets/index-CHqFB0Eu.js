(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();const C=[{id:1,name:"Световой меч Дарт Вейдера",category:"lightsabers",price:15e3,image:"🔴",stock:5,popularity:95},{id:2,name:"Световой меч Люка Скайвокера",category:"lightsabers",price:12e3,image:"🟢",stock:12,popularity:90},{id:3,name:"Световой меч Мейс Винду",category:"lightsabers",price:14e3,image:"🔵",stock:3,popularity:75},{id:4,name:"Световой меч Кайло Рена",category:"lightsabers",price:16e3,image:"🔴",stock:8,popularity:85},{id:5,name:'Футболка "Эмблема Альянса"',category:"clothing",price:2500,image:"👕",stock:45,popularity:80},{id:6,name:'Худи "Империя"',category:"clothing",price:4500,image:"🧥",stock:20,popularity:70},{id:7,name:'Футболка "Дарт Вейдер"',category:"clothing",price:2800,image:"👕",stock:60,popularity:92},{id:8,name:'Куртка "Пилот X-Wing"',category:"clothing",price:8e3,image:"🧥",stock:7,popularity:65},{id:9,name:"Статуэтка R2-D2",category:"merch",price:5500,image:"🤖",stock:15,popularity:88},{id:10,name:"Фигурка Бобы Фетта",category:"merch",price:4200,image:"🎭",stock:10,popularity:82},{id:11,name:'Брелок "Молот Галактики"',category:"merch",price:800,image:"🔑",stock:100,popularity:60},{id:12,name:"Маска Дарт Вейдера",category:"merch",price:3500,image:"🎭",stock:25,popularity:78},{id:13,name:'Набор значков "Звёздные войны"',category:"merch",price:1200,image:"🏅",stock:50,popularity:55},{id:14,name:'Зонт "Звезда Смерти"',category:"merch",price:1800,image:"☂️",stock:30,popularity:72},{id:15,name:'Термокружка "Люк Скайвокер"',category:"merch",price:950,image:"☕",stock:40,popularity:68},{id:16,name:'Рюкзак "Флотан"',category:"merch",price:6500,image:"🎒",stock:6,popularity:50}],v={lightsabers:"Световые мечи",clothing:"Одежда",merch:"Мерч"},$={email:"qwe@qwe.ru",password:"qweQWE"},D="SW10",h=.1,M="1111111111111111";function s(){const e=localStorage.getItem("cart");return e?JSON.parse(e):[]}function b(e){localStorage.setItem("cart",JSON.stringify(e))}function U(e){const t=s(),a=t.find(i=>i.product.id===e);if(a)a.quantity++;else{const i=C.find(r=>r.id===e);i&&t.push({product:i,quantity:1})}return b(t),g(),t}function q(e){let t=s();return t=t.filter(a=>a.product.id!==e),b(t),g(),t}function S(e,t){const a=s(),i=a.find(r=>r.product.id===e);if(i){if(t<=0)return q(e);i.quantity=t,b(a),g()}return a}function H(){localStorage.removeItem("cart"),g()}function P(){return s().reduce((t,a)=>t+a.product.price*a.quantity,0)}function E(){return s().reduce((t,a)=>t+a.quantity,0)}function g(){const e=E(),t=document.getElementById("cart-count");t&&(t.textContent=e.toString())}function w(){const e=localStorage.getItem("user");return e?JSON.parse(e):null}function O(e){e?localStorage.setItem("user",JSON.stringify(e)):localStorage.removeItem("user"),N()}function B(e,t){return e===$.email&&t===$.password?(O({email:e,isLoggedIn:!0}),!0):!1}function A(){O(null)}function N(){const e=w(),t=document.getElementById("auth-btn");t&&(e?.isLoggedIn?(t.textContent="Выход",t.classList.add("logged-in")):(t.textContent="Вход",t.classList.remove("logged-in")))}function I(){const e=localStorage.getItem("reviews");return e?JSON.parse(e):[]}function F(e){const t=I(),a={...e,id:Date.now(),date:new Date().toLocaleDateString("ru-RU")};t.push(a),localStorage.setItem("reviews",JSON.stringify(t))}function L(){const e=localStorage.getItem("orders");return e?JSON.parse(e):[]}function J(e){const t=L();t.push(e),localStorage.setItem("orders",JSON.stringify(t))}function j(e){return e.toUpperCase()===D?{valid:!0,discount:h,message:"Промокод применён! Скидка 10%"}:{valid:!1,discount:0,message:"Неверный промокод"}}let l="",o={category:"",minPrice:0,maxPrice:2e4,sortBy:"popularity"},u=!1,f=0;function _(e){const t=document.querySelector(".custom-alert-overlay");t&&t.remove();const a=document.querySelector(".custom-alert");a&&a.remove();const i=document.createElement("div");i.className="custom-alert-overlay";const r=document.createElement("div");r.className="custom-alert",r.textContent=e,document.body.appendChild(i),document.body.appendChild(r),setTimeout(()=>{i.remove(),r.remove()},2e3),i.addEventListener("click",()=>{i.remove(),r.remove()})}function W(){g(),N(),x(),Q(),window.addEventListener("hashchange",x)}function x(){const e=window.location.hash.slice(1)||"/",t=document.getElementById("main-content");t&&(e==="/"||e===""?(l="home",K(t)):e==="/catalog"?(l="catalog",p(t)):e==="/cart"?(l="cart",m(t)):e==="/checkout"?(l="checkout",te(t)):e==="/reviews"?(l="reviews",T(t)):e==="/success"?(l="success",re(t)):e==="/failure"?(l="failure",ie(t)):e==="/profile"&&(l="profile",k(t)))}function Q(){document.getElementById("auth-btn")?.addEventListener("click",()=>{w()?.isLoggedIn?A():R()}),document.getElementById("close-auth")?.addEventListener("click",y),document.getElementById("auth-modal")?.addEventListener("click",e=>{e.target===e.currentTarget&&y()}),document.getElementById("auth-form")?.addEventListener("submit",G),document.getElementById("auth-toggle-link")?.addEventListener("click",z),document.querySelector(".cart-link")?.addEventListener("click",e=>{e.preventDefault(),window.location.hash="#/cart"})}function R(){document.getElementById("auth-modal")?.classList.add("active")}function y(){if(document.getElementById("auth-modal")?.classList.remove("active"),document.getElementById("auth-form")?.reset(),l==="profile"){const e=document.getElementById("main-content");e&&k(e)}}let d=!0;function z(e){e.preventDefault(),d=!d,document.getElementById("auth-title").textContent=d?"Вход":"Регистрация",document.getElementById("auth-submit").textContent=d?"Войти":"Регистрация",document.getElementById("auth-toggle-text").textContent=d?"Нет аккаунта?":"Есть аккаунт?",document.getElementById("auth-toggle-link").textContent=d?"Регистрация":"Вход"}function G(e){e.preventDefault();const t=document.getElementById("email").value,a=document.getElementById("password").value;if(!t||!a){alert("Пожалуйста, заполните все поля");return}d?B(t,a)?y():alert("Неверные учетные данные"):(B(t,a),y())}function K(e){e.innerHTML=`
    <section class="hero">
  ...
  `}function Y(){const e=document.getElementById("category-filter"),t=document.getElementById("min-price"),a=document.getElementById("max-price"),i=document.getElementById("sort-filter");e.value=o.category,t.value=o.minPrice.toString(),a.value=o.maxPrice.toString(),i.value=o.sortBy,e.addEventListener("change",()=>{o.category=e.value,p(document.getElementById("main-content"))}),t.addEventListener("change",()=>{o.minPrice=parseInt(t.value)||0,p(document.getElementById("main-content"))}),a.addEventListener("change",()=>{o.maxPrice=parseInt(a.value)||2e4,p(document.getElementById("main-content"))}),i.addEventListener("change",()=>{o.sortBy=i.value,p(document.getElementById("main-content"))}),document.querySelectorAll(".btn-add-cart").forEach(r=>{r.addEventListener("click",n=>{const c=parseInt(n.target.getAttribute("data-id"));U(c),_("Товар добавлен в корзину!")})})}function m(e){const t=s();if(t.length===0){e.innerHTML=`
    ...
    `;return}const a=P(),i=u?a*h:0,r=a-i;e.innerHTML=`
    <h1>Корзина</h1>
    <div class="cart-page">
  ...
  `}function ee(e){document.querySelectorAll(".quantity-btn.minus").forEach(t=>{t.addEventListener("click",a=>{const i=parseInt(a.target.getAttribute("data-id")),r=e.find(n=>n.product.id===i);r&&(S(i,r.quantity-1),m(document.getElementById("main-content")))})}),document.querySelectorAll(".quantity-btn.plus").forEach(t=>{t.addEventListener("click",a=>{const i=parseInt(a.target.getAttribute("data-id")),r=e.find(n=>n.product.id===i);r&&(S(i,r.quantity+1),m(document.getElementById("main-content")))})}),document.querySelectorAll(".cart-item-remove").forEach(t=>{t.addEventListener("click",a=>{const i=parseInt(a.target.getAttribute("data-id"));q(i),m(document.getElementById("main-content"))})}),document.getElementById("apply-promo")?.addEventListener("click",()=>{const t=document.getElementById("promo-input"),a=j(t.value),i=document.getElementById("promo-message");a.valid?(u=!0,i.textContent=a.message,i.className="promo-message success",m(document.getElementById("main-content"))):(i.textContent=a.message,i.className="promo-message error")})}function te(e){if(s().length===0){window.location.hash="#/cart";return}e.innerHTML=`
  ...
  `,document.getElementById("checkout-form")?.addEventListener("submit",ae)}function ae(e){if(e.preventDefault(),document.getElementById("card-number").value.replace(/\s/g,"")===M){const a=s(),i=P(),r=u?i*h:0,n=i-r,c={id:"ORD-"+Date.now(),items:a,total:n,promoApplied:u,date:new Date().toLocaleDateString("ru-RU")};J(c),H(),u=!1,window.location.hash="#/success"}else window.location.hash="#/failure"}function k(e){const t=w(),a=L(),i=I();if(!t?.isLoggedIn){e.innerHTML=`
    ...
    `,document.getElementById("login-required-btn")?.addEventListener("click",R);return}e.innerHTML=`
    <div class="profile-page">
  ...
  `,document.getElementById("logout-btn")?.addEventListener("click",()=>{A(),window.location.hash="#/";const r=document.getElementById("main-content");r&&k(r)})}function re(e){const t=L(),a=t[t.length-1];e.innerHTML=`
...
//# sourceMappingURL=index-CHqFB0Eu.js.map
